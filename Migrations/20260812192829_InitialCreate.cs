        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePricePerPassenger = table.Column<decimal>(type: "numeric", nullable: false),
                    DurationMinutes = table.Column<int>(type: "integer", nullable: false),
                    DistanceKm = table.Column<double>(type: "double precision", nullable: false),
                    AvailabilityScore = table.Column<double>(type: "double precision", nullable: false),
                    ComfortScore = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsEstimatedData = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TripId = table.Column<int>(type: "integer", nullable: false),
                    TransportOptionId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    CostScore = table.Column<double>(type: "double precision", nullable: false),
                    DurationScore = table.Column<double>(type: "double precision", nullable: false),
                    AvailabilityScore = table.Column<double>(type: "double precision", nullable: false),
                    ComfortScore = table.Column<double>(type: "double precision", nullable: false),
                    IsRecommended = table.Column<bool>(type: "boolean", nullable: false),
                    IsCheapest = table.Column<bool>(type: "boolean", nullable: false),
                    IsFastest = table.Column<bool>(type: "boolean", nullable: false),
                    IsMostConvenient = table.Column<bool>(type: "boolean", nullable: false),
                    ReasoningText = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripAnalyses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripAnalyses_TransportOptions_TransportOptionId",
                        column: x => x.TransportOptionId,
                        principalTable: "TransportOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TripAnalyses_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportOptions_Source_Destination",
                table: "TransportOptions",
                columns: new[] { "Source", "Destination" });

            migrationBuilder.CreateIndex(
                name: "IX_TripAnalyses_TransportOptionId",
                table: "TripAnalyses",
                column: "TransportOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_TripAnalyses_TripId",
                table: "TripAnalyses",
                column: "TripId");
